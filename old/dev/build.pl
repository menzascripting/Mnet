...
print "    - Ensure Changes document is updated with changes to codebase\n";
print "    - Update Changes doc with new version number for public releases\n";
print "    - Execute a `git commit` to update your repo\n";
